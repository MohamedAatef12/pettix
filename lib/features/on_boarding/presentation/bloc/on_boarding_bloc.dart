...
class OnBoardingBloc extends Bloc<OnBoardingEvent, OnBoardingState> {
  final List<OnBoardingSlide> slides = [
    OnBoardingSlide(
      ...
      desc:
          "Share your pet_profile’s daily adventures, post cute pictures, and engage with a loving pet_profile community  just like you!",
    ),
    OnBoardingSlide(
    ...
    OnBoardingSlide(
      ...
      desc:
          "Discover food, toys, and grooming essentials.  Shop easily for your furry friend from  trusted pet_profile brands.",
    ),
  ];
