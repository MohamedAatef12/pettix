...
abstract class AppText {
  ...
  static String get shareDailyAdventures =>
      'Share your pet’s daily adventures, post cute pictures, and engage with a loving pet community \u2028just like you!'.tr();
  static String get careSafetySecondChances => 'Care. Safety. Second Chances.'.tr();
  static String get findLovingHomes =>
      'Find loving homes for pets, access trusted clinics, or get urgent help in emergencies — all in one\u2028 convenient place.'.tr();
  static String get everythingYourPetNeeds => 'Everything Your Pet Needs.'.tr();
  static String get discoverFoodToys =>
      'Discover food, toys, and grooming essentials. \u2028Shop easily for your furry friend from \u2028trusted pet brands.'.tr();
  static String get loginTitle => 'Sign in to your account'.tr();
  static String get loginSubtitle => 'Enter your email and password to log in'.tr();
  ...
  static String get password8Chars => 'Password must be at least 8 characters'.tr();
  static String get passwordUppercase => 'Must contain at least one uppercase letter'.tr();
  static String get passwordLowercase => 'Must contain at least one lowercase letter'.tr();
  ...
  static String get createAccountToContinue => 'Create an account to continue! '.tr();
  ...
  static String get identityVerified => 'Your identity has been successfully verified.'.tr();
  ...
  static String get resetCompleteWelcomeBack => 'Reset complete. Welcome back!'.tr();
  ...
  static String get noNotificationsYet => "You have no notifications yet,\n please Come back later.".tr();
  static String get notificationTitle => 'Notification Title'.tr();
  static String get notificationDesc =>
      'This is a brief description of the notification. It provides more details about the notification content.'.tr();
